...
// O Game Guide: o leitor do guia DO JOGO (categorias -> paginas -> texto).
// So existe fora da build TOOLS_ONLY - main.c inclui este arquivo dentro de um unico
// #if !TOOLS_ONLY, entao aqui dentro nao ha nenhuma condicional.
